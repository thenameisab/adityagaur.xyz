    ...
    panels={[
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "Glean, Coveo, Elastic, Onyx, Notion AI" },
      ...
      },
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "GoSearch, and Dashworks until it was sunset in July 2025" },
      ...
      },
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "Microsoft 365 Copilot, and Sana on Workday's identity backbone" },
      ...
      },
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "Mem0, Zep/Graphiti, Cognee, Letta, Supermemory, LlamaIndex" },
      ...
      },
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "Fireflies, Otter, Read AI, Fathom, Circleback" },
      ...
      },
      {
        ...
        items: [
          { marker: "→", label: "Who", detail: "Kong, TrueFoundry, LiteLLM, Vellum, Portkey, OpenRouter, Databricks, Cloudflare, Martian, Eden AI" },
