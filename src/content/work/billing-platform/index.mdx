...
<ArtifactSlot code="A1" name="The month-end pipeline" description="The seventy-seven sheets, live — one row per (client, API), reduced to the single settlement this chapter argues a spreadsheet can't reliably produce." />
...
<ArtifactSlot code="A0" name="Derive and finalize" description="The bigger version of the control above — derive and finalize as one state machine, scrubbed live rather than told." />
...
<ArtifactSlot code="A4" name="The effective-dated pattern" description="The full table map — the effective-dated pattern traced across rates, sandbox state, and client tiers as one recurring shape, not twenty-three separate designs." />
...
<ArtifactSlot code="A6" name="The gap register" description="All 19 surfaces, their reconciliation status, and the four root causes — including the slab window-pooling gap this chapter describes, at row level." />
