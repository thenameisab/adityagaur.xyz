...
<Plate
  drums="orange-teal"
  n={1}
  subject="five systems, five answers"
  caption="One question, five systems, five answers. Each number is correct inside the system that produced it."
  source="Illustrative figures, as specified in the draft."
>
  <FiveAnswers />
</Plate>
...
<Plate
  drums="orange-teal"
  n={2}
  subject="the confident answer"
  caption="What the assistant returned. The disclosure is real, present, and easy to miss."
>
  <ConfidentAnswer />
</Plate>
...
<Plate
  drums="orange-teal"
  n={3}
  subject="what makes an island"
  caption="Each defining trait of an island, and the specific way it breaks an agent."
>
  <Switcher
    label="Island traits"
    panels={[
...
<Plate
  drums="orange-teal"
  n={4}
  subject="reliability, compounded"
  caption="Per-step reliability against end-to-end success. Move either control — the collapse is just p to the power of n."
  source="The article's own arithmetic. No model or estimate involved."
>
  <Compounding />
</Plate>
...
<Plate
  drums="orange-teal"
  n={5}
  subject="the connective layer"
  caption="The shape the argument points at. Interfaces on top, one neutral layer you own, records underneath."
>
  <ConnectiveLayer />
</Plate>
...
<Plate
  drums="orange-teal"
  n={6}
  subject="the archipelago index"
  caption="Score all seven. The total matters less than the dimensions where you and your colleagues disagree."
>
  <ArchipelagoIndex />
</Plate>
